...
update: function(){
    ...
    animate = whatAnimate(movement, action, boss)
...
//            player.scale.x =-1;
    ...
    function whatAnimate (movement, action, enemy){
        ...
        dictLeft = {
            idle : ["idleLeft", enemy.body.setSize(30, 42, 35, 22)],
            move : ["moveLeft", enemy.body.setSize(30, 42, 35, 22)],
            taunt : ["tauntLeft", enemy.body.setSize(30, 42, 35, 22)],
            attack1 : ["attack1Left", enemy.body.setSize(56, 57, 10, 7)],
            attack2 : ["attack2Left", enemy.body.setSize(56, 42, 10, 22)],
            attack3 : ["attack3Left", enemy.body.setSize(38, 53, 35, 11)],
            attack4 : ["attack4Left", enemy.body.setSize(87, 42, 7, 22)],
            damage1 : ["damage1Left", enemy.body.setSize(30, 42, 35, 22)],
            damage2 : ["damage2Left", enemy.body.setSize(30, 42, 35, 22)],
            death : ["deathLeft", enemy.body.setSize(30, 42, 35, 22)],

            
        }
        
        dictRight = {
            idle : ["idleRight", enemy.body.setSize(33, 42, 28, 22)],
            move : ["moveRight", enemy.body.setSize(33, 42, 28, 22)],
            taunt : ["tauntRight", enemy.body.setSize(33, 42, 28, 22)],
            attack1 : ["attack1Right", enemy.body.setSize(60, 57, 28, 7)],
            attack2 : ["attack2Right", enemy.body.setSize(60, 42, 28, 22)],
            attack3 : ["attack3Right", enemy.body.setSize(37, 53, 24, 11)],
            attack4 : ["attack4Right", enemy.body.setSize(87, 42, 2, 22)],
            damage1 : ["damage1Right", enemy.body.setSize(33, 42, 28, 22)],
            damage2 : ["damage2Right", enemy.body.setSize(33, 42, 28, 22)],
            death : ["deathRight", enemy.body.setSize(33, 42, 28, 22)],
        ...
        if (movement == 1){
            ...
            size = dictLeft[action]
            size = size[1]
            toDo = dictLeft[action]
            toDo = toDo[0]
            return enemy.animations.play(dictLeft[toDo])
            
        }
        if (movement == 2){
            size = dictRight[action]
            size = size[1]
            toDo = dictRight[action]
            toDo = toDo[0]
            return enemy.animations.play(dictRight[toDo])
